...
export class LoginFormComponent {
    ...
    constructor(private fb: FormBuilder, private userService: UserService, private cartService: CartService, private toast: HotToastService, private router: Router, private toastService: DisplayToastService) {
            ...
            if (this.loginForm.valid) {
                ...
                this.userService.loginUserAPI(loginUserData).subscribe(
                    async (res) => {
                        ...
                        localStorage.setItem("toast", JSON.stringify({ type: "success", msg: `Login Successful & Your Cart Items are Fetched` }))
